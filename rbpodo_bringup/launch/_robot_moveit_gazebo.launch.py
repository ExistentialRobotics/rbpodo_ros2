...
def generate_launch_description():
    ...
    robot_moveit_common_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('rb3_730es_u_moveit_config'), 'launch', '_robot_moveit_common.launch.py'])),
        launch_arguments={
    ...
    robot_gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('rbpodo_bringup'), 'launch', '_robot_beside_table_gazebo.launch.py'])),
        launch_arguments={
